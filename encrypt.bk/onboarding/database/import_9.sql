...
CREATE TABLE IF NOT EXISTS `course_discussion_report` (
  ...
  `inserted_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS `course_lectures` (
  ...
  `cl_lecture_preview` enum('0','1','') DEFAULT '0',
  `cl_lecture_image` varchar(255) NOT NULL DEFAULT 'default-lecture.jpg',
