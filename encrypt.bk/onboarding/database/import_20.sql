...
CREATE TABLE IF NOT EXISTS `notification_log` (
  ...
  `nl_account_id` int(11) NOT NULL,PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  `p_title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_short_description` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `p_content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
