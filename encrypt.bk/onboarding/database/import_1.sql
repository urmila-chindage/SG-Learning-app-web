...
CREATE TABLE IF NOT EXISTS `routes` (
  ...
  `r_item_type` varchar(255) DEFAULT NULL,
  `r_item_id` int(11) DEFAULT NULL,PRIMARY KEY (id)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ct_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ct_status` enum('1','0') NOT NULL DEFAULT '0',
  `ct_parent_id` int(11) NOT NULL DEFAULT '0',
  `ct_slug` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
