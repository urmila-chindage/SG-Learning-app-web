                ...
                <div class="rTable content-nav-tbl" style="">
                    <div class="rTableRow">
                        ...
                        <div class="rTableCell">
                            <a href="#!." class="select-all-style"><label> <input class="faculty-checkbox-parent" type="checkbox">  Select All</label><span id="selected_faculties_count"></span></a>
                        </div>
                        <div class="rTableCell dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="dropdown_role_text" data-role-id="0">All Faculties<span class="caret"></span></a>
                    ...
                    <div class="list-col">
                         <span class="wrap-mail ellipsis-hidden"> 
                            <div class="ellipsis-style">
                                ...
                                <a href="#">Assignment Name Goes Here.Assignment Name Goes HereAssignment Name Goes Here</a>
                            </div>
                        </span>
                    </div>
<!--                    <div class="list-arrow pos-rel">
                ...
                <div class="col-sm-12 rel-top50 course-cont-wrap"> 
                    <div class="table course-cont rTable right-table" style="" id="group_detail_wrapper">
                              ...
                              <div class="rTableRow">
                                ...
                                <div class="rTableCell pad0" style="min-width:100px;">
                                    	<span class="green-text">42 Marks</span>
  ...
  <div class="rTableRow">
                                ...
                                <div class="rTableCell pad0" style="min-width:100px;">
                                    	<button class="btn btn-green selected">EVALUVATE<ripples></ripples></button>
