                ...
                <div class="changed-container-for-forum">
                    ...
                    <div class="searchBox-and-btn">
                        ...
                        <span class="searchbox-btn">
                            <a href="<?php echo admin_url('forum').$forum->forum_slug.'/create_forum_topic';?>" class="orange-flat-btn-for-search orange-flt-btn-search-height">Post a new topic</a>
                        </span><!--searchbox-btn--> 
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-close-wrap clearfix">
                <h3 class="delet-post-head">Delete Topic</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <span class="oops-content">
                            This Topic will be deleted and you won't be able to find it anymore. This action cannot be undone.
                        </span>
                            <!--oops-content-->
