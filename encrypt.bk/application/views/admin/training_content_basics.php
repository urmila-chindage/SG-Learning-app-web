            ...
            <div class="row-fluid course-cont">
                <div class="col-sm-12 pad0">
                    ...
                    <div class="rTable course-status-cont">
                        <div class="row">
                            <div class="col-md-4 course-content-status p0">
                                <a href="<?php echo admin_url('course/users/'.$course['id']).'?&filter=all' ?>" style="display:block;padding:10px">
                                    <span class="big-head">
                            ...
                            <div class="col-md-4 course-content-status p0">
                                <a href="<?php echo admin_url('coursebuilder/home/'.$course['id']); ?>" style="display:block;padding:10px">
                                    <span class="big-head">
                                        <?php echo $quiz ?>
                                    </span>
                                    <p>
                            ...
                            <div class="col-md-4 course-content-status p0">
                                <a href="<?php echo admin_url('course/users/'.$course['id']).'?&filter=completed' ?>" style="display:block;padding:10px">
                                    <span class="big-head">
                                        <?php echo $completed ?>
                                    </span>
                                    <p>
                    ...
                    <div class="list-style-wrap container-fluid">
                        <h5 class="overview-info">You may have created and launched your own course already, kindly ignore if so. 
                        ...
                        <div class="accordion-container">
                          ...
                          <div class="panel">
                            <ul>
                                ...
                                <li>- Upload the course image(size:760 X 420)px.</li>
                          ...
                          <button class="accordion">
                            ...
                            ?>
                            <span class="step-title">STEP 2: ASSIGN FACULTIES</span>
                          </button>
                          <div class="panel">
                            <ul>
                          ...
                          <button class="accordion">
                            ...
                            ?>
                            <span class="step-title">STEP 3: ADD COURSE CONTENTS</span>
                          </button>
                          <div class="panel">
                            <ul>
                          ...
                          <button class="accordion">
                            ...
                            ?>
                            <span class="step-title">STEP 4: ACTIVATION</span>
                          </button>
                          <div class="panel">
                            <ul>
