...
?>
    ...
    <div class='course-bulder-content-inner'>
                   ...
                   <div class="buldr-header inner-buldr-header clearfix">
                        ...
                        <div class="pull-right rite-side">
                            ...
                            <a href="<?php echo admin_url('coursebuilder/home/'.$lecture['cl_course_id']) ?>">
                                <button class="btn btn-red" id="back_button"><i class="icon icon-left"></i><?php echo lang('back') ?></button></a>
                        </div>
                   </div>
                <!-- !.top Header -->
                      ...
                      <div class="panel-body">
                            ...
                            <div class="form-group clearfix" style="<?php echo ($course_details['cb_has_lecture_image'] == 1) ? "display:block" : "display:none" ?>" >
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div id="lecture_status_wraper_<?php echo $lecture['id'] ?>" class="<?php echo $status_mark ?>-section"></div>
    ...
    <div class="col-sm-6 builder-right-inner" style="overflow: hidden; padding: 0px;"> <!-- right side bar section -->
            <!-- coursebuilder options starts-->
                <!-- <div class="coursebuilder-options-holder">
                    
                </div> -->
            <!-- coursebuilder options ends -->
            
            <!-- Preivew of  youtube content will show here -->
            <div class="preivew-area  text-center" style="padding: 0px; height: 100%">
                <!-- <img src="images/ppt.jpg" class="default" alt="default" /> --> <!-- Default image if needed -->
                    ...
                    <div class="preivew-area overflw-Y-scroll text-center">
                        <div class="default-view-txt">
                            ...
                            <p class="">No file is Uploaded. Please Upload a file<br>
                                Supported file formats: .mp4, .ppt, .pptx, .doc, .pdf<br>
                                After Upload complete it will take few minutes to show preview.
                            </p>
                        </div>
                    </div>            
                    <?php else: ?>
                       
                    <?php $doc_url = document_path(array('course_id' => $lecture['cl_course_id'])).$lecture['cl_org_file_name'];  ?>
                    <iframe width="100%" height="100%" style="border: none;height:100%" src="<?php echo config_item('doc_viewer').$doc_url ?>&embedded=true"></iframe>
                    <?php endif; ?> 
                </div>            
            </div>
             <!-- !.Preivew of  youtube content will show here -->
