       ...
       <!-- top Header with drop down and action buttons -->
            ...
            <div class="preivew-area test-content">
                ...
                <div class="form-horizontal"> 
                    ...
                    <form class="form-horizontal" id="question_form" method="POST" action="<?php echo admin_url('challenge_zone/question/'.$id.'/'.$cz_id) ?>">
                        <!-- Text Box  -->
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" name="q_category" id="q_category" placeholder="eg: Logical Reasoning" autocomplete="off" value="<?php echo isset($q_category)?$q_category:'' ;?>" />
...
<!--                                <select class="form-control" id="positive_mark" name="q_positive_mark">
                                   <?php //for($i=1; $i<6; $i++): ?>
                                    <option  <?php //echo ($q_positive_mark==$i)?$selected:''; ?> value="<?php //echo $i ?>"><?php //echo $i.' '.  lang('mark') ?></option>
                                    <?php //endfor; ?>
                                </select>-->
                            </div>
                            <div class="col-sm-4">
...
<!--                                <select class="form-control" id="negative_mark" name="q_negative_mark">
                                   <?php //for($i=0; $i<6; $i++): ?>
                                    <option <?php //echo ($q_negative_mark==$i)?$selected:''; ?> value="<?php //echo $i ?>"><?php //echo $i.' '.  lang('mark') ?></option>
                                    <?php //endfor; ?>
                                </select>-->
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <a href="<?php echo admin_url('challenge_zone/basics/'.$cz_id) ?>" class="btn btn-red" data-dismiss="modal"><?php echo lang('cancel') ?></a>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    var __category_id = '<?php echo $cz_category; ?>';
</script>
