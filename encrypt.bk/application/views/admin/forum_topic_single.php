    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-close-wrap clearfix">
                <h3 class="delet-post-head">Delete Comment</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <span class="oops-content">
                            This Comment will be deleted and you won't be able to find it anymore. This action cannot be undone.
                        </span>
                            <!--oops-content-->
...
<script src="<?php echo assets_url() ?>/js/topic_single.js"></script>