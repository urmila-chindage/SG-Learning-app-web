...
<div class="right-wrap base-cont-top container-fluid pull-right right-wrap-height-adjust" style="top:95px!important;">
        ...
        <a href="<?php echo admin_url('bundle/users/' . $bundle_id) ?>" class="btn btn-big btn-blue full-width-btn">
            CANCEL
            <ripples></ripples>
        </a>
...
<div class="container-fluid nav-content nav-course-content add-question-block" style="width:100% !important;top: 0px !important;height: 50px;">
    <div class="col-sm-12 bottom-line question-head">
        ...
        <span class="cb-close-qstn" style="right: 30px;"><i class="icon icon-cancel-1" onclick="location.href='<?php echo admin_url('bundle/users/' . $bundle_id) ?>'"></i></span>
    </div>
...
<script type="text/javascript">
    ...
    var __bundle_id     = <?php echo $bundle_id; ?>;
...
function getUsers() {
    ...
    $.ajax({
        url: admin_url + 'bundle/enroll_users_json',
        type: "POST",
        data: { "is_ajax": true, "bundle_id":__bundle_id, "institute_id": __institute_id, "branch_id": __branch_id, "keyword": keyword, 'limit': __limit, 'offset': __offset },
...
function enrollStudents()
{
    ...
    $('#enroll_user_confirmed').removeAttr('onclick');
    $.ajax({
        url: admin_url+'bundle/enroll_students',
        type: "POST",
        data:{"is_ajax":true, "bundle_id":__bundle_id, 'user_ids':JSON.stringify(__user_selected)},
        ...
        success: function(response) {
            ...
            if(data['success'] == true)
            {
                ...
                location.href = admin_url+'bundle/users/'+__bundle_id+'?success';
            } else
            {
