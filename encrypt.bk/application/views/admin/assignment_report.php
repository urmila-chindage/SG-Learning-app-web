...
<section class="content-wrap create-group-wrap settings-top reports-left">
   ...
   <div class="col-sm-12 nav-content faculty-nav-content">
                ...
                <div class="rTable content-nav-tbl" style="">
                    <div class="rTableRow">
                        ...
                        <div class="rTableCell dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" id="dropdown_role_text" data-role-id="0">Select Course<span class="caret"></span></a>
                        ...
                        <div class="rTableCell">
                            <div class="save-btn"><button class="pull-right btn btn-green" onclick="addFacultyForm();">EXPORT</button></div>
                        </div>
                    </div>
                </div>
            </div>
                         ...
                         <span class="wrap-mail ellipsis-hidden"> 
                            <div class="ellipsis-style">
                                <span class="icon-wrap-round img">
                                     <img src="http://sdpk.ofabee.com/uploads/sdpk.ofabee.com/user/d8cc0a61ed5b7c71359ac9895a1d7743.jpg">
                                </span>            
                                <a href="#">Sajan Christudas</a>
                            </div>
                        </span>
                    </div>
                </div>           
    ...
    <div class="col-sm-6 pad0 right-content list-right">
        <!-- Nav section inside this wrap  --> <!-- START -->
        <!-- =========================== -->
        <div class="container-fluid nav-content no-nav-style pos-abslt nav-js-height width-100p" id="preview_wrapper">
                    <div class="col-sm-12">
                        <div class="rTable content-nav-tbl" style="">
                            <div class="rTableRow">
            ...
            <div class="row">
                <div class="col-sm-12 rel-top50 course-cont-wrap"> 
                    <div class="table course-cont rTable right-table" style="" id="group_detail_wrapper">
  						...
  						<div class="col-md-12 assignment-image">
                            <span class="icon-wrap-round img assignment-img">
                                <img src="http://sdpk.ofabee.com/uploads/sdpk.ofabee.com/user/d8cc0a61ed5b7c71359ac9895a1d7743.jpg" width="90">
                            </span>
                            <h3>Sajan Christudas</h3>
                        </div>
                        <div class="strength-block">
                            <div class="col-md-12 topic-name"><b>Topic Name</b>:(04.55 avg)</div>
                            <div class="col-md-12 progress-box">
                               <div class="progress-left">40%</div>
                               <div class="progress sml-progress strength-progress">
                                   <div class="progress-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 40%;">
                                        <span class="sr-only">40% Complete</span>
                                    </div>
                               </div>
                               <div class="progress-right">60%</div>
                            </div>
  					     </div>
...
*/  
    ...
    function attachUsers(param)
    {
        if(__userSelected.length == 0)
        {
            $('#add-user-to-group .modal-body').prepend(renderPopUpMessage('error', 'Please select atleast one user to batch'));
            scrollToTopOfPage();
            return false;
        }
        $.ajax({
