...
<div class="nav-group pad0">
    <div class="container container-altr">
        <div class="container-reduce-width">            
              <ul class="nav nav-tabs my-dashboard-ul">
                <li ><a  href="<?=site_url().'dashboard'?>">Dashboard</a></li>
                <li  ><a  id="my_courses_btn" href="<?=site_url().'dashboard/mycourses'?>"><?php echo lang('my_courses');?></a></li>
                <li><a  href="<?=site_url().'dashboard/assignments'?>"><?php echo 'Assignments';?></a></li>
                <li class="active"><a  href="<?=site_url().'dashboard/result'?>"><?php echo lang('result');?></a></li>
                <li><a  href="<?=site_url().'dashboard/scorecard'?>"><?php echo 'Score Card';?></a></li>
              </ul>
       </div>
    </div>
</div>
...
<div class="all-challenges">
    <div class="container container-altr">
        <div class="container-reduce-width">
         <div id="dashboard-my-results" class="">
