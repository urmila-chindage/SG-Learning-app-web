...
<link href="<?php echo assets_url() ?>css/redactor/css/alignment.css" rel="stylesheet">
            ...
            <div class="container  container-res-chnger-frorm-page">
                <div class="changed-container-for-forum">
                    ...
                    <span class="create-new-input-holder">
                        <input type="rext" placeholder="Add a title" id="topic_title" value="<?php echo (isset($title) ? $title : ''); ?>" name="title" class="add-title-inputbox">
                    </span><!--input-holder-->
    ...
    <section>
        <div class="redactor-text-holder">
            <div class="container  container-res-chnger-frorm-page">
                <div class="changed-container-for-forum">
                    <textarea class="redactor-text-area" id="redactor" name="content" placeholder="Add topic description"></textarea><!--redactor-text-area-->
                    <div class="redactor-btns clearfix">
                        ...
                        <span class="redactor-orange-btn"><a href="<?php echo site_url('forum').'/'.$forum_slug; ?>" class="redactor-grey-flat-btn">Cancel</a></span>
                    </div><!--redactor-btns-->
                </div><!--changed-container-for-forum-->
