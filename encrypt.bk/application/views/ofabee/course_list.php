                ...
                <div class="sction_2">
                    ...
                    <div class="tab-content responsive">
                        <div class="tab-pane active" id="courses">
                            ...
                            <?php //echo "<pre>"; print_r($course_list);?>
                            <?php foreach($course_list as $key => $course): ?>
                                  <?php if($course['cb_access_validity'] == 2){
                                        if(date('Y-m-d')<= $course['cb_validity_date']){ ?>
...
<script type="text/javascript" src="<?php echo assets_url().'themes/'.$this->config->item('theme').'/js/course_list.js'; ?>" ></script>
