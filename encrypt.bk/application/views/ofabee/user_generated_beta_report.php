...
<section id="fundamentals">
	<div class="fundamentals">
        ...
        <div class="container-reduce-width">
          <?php 
            $assesment_date     = $us_test_attempt_details['uga_attempted_date'];
            $attempted_date     = date("M j Y", strtotime($assesment_date));
            
            //$attended_time      = $us_test_attempt_details['uga_duration']/60;
            //$duration_in_minutes= substr($attended_time, 0, 4);
            $duration_in_minutes= secondsToTime($us_test_attempt_details['uga_duration']);
          ?>
        	<span class="funda-date"><?php echo $attempted_date; ?></span>
            <h2 class="funda-head"><?php echo (isset($user_test_details['uga_title'])? $user_test_details['uga_title']: '');?></h2> 
            ...
            <?php if(isset($lecture['answers'][$key])) : if($lecture['answers'][$key]['ugar_mark'] > 0):?>
            <?php $right_answer_full++; endif; endif; ?>

            <?php if(isset($lecture['answers'][$key])) : if(($lecture['answers'][$key]['ugar_answer']!="") && ($lecture['answers'][$key]['ugar_mark'] <= 0)):?>
            ...
            <?php if(isset($lecture['answers'][$key])) : if(($lecture['answers'][$key]['ugar_answer']=="")):?>

            <?php $unattended_answer_full++; endif; endif; ?>

            <?php if(isset($lecture['answers'][$key])) :?>
            <?php $full_time_taken = $full_time_taken + $lecture['answers'][$key]['ugar_duration']; endif;?>

            <?php if(isset($lecture['answers'][$key])) :?>
            <?php $full_marks_scored = $full_marks_scored + $lecture['answers'][$key]['ugar_mark']; endif;?>
            ...
            <?php endforeach; endif; ?>
            	...
            	<li class="mark-scored-green">
                	<div class="funda-space funda-space-bg-rm">
                    	<span class="funda-strip-number color-white"><?php echo $full_marks_scored; ?></span>
                        <span class="fund-strip-text color-white">Marks Scored</span>
                    </div>
                </li>  
                
                <?php /* ?><li class="view-rank-list-wraper">
                	<ul class="view-mark-list-ul">
                    	<li><a href="<?php echo site_url('report/assessment/'.$us_test_attempt_details['uga_assessment_id'])?>" class="orange-flat-btn">View rank list</a></li>
                    </ul>
                </li>  <?php */ ?>
            </ul>            
        	...
        	<div class="table-responsive">          
              <table class="table">
                ...
                <?php foreach($category_question as $question_category): ?>
                    <?php if(isset($lecture['answers'][$question_category])) : if($lecture['answers'][$question_category]['ugar_mark'] > 0):?>

                    <?php $right_answer++; endif; endif; ?>

                    <?php if(isset($lecture['answers'][$question_category])) : if(($lecture['answers'][$question_category]['ugar_answer']!="") && ($lecture['answers'][$question_category]['ugar_mark'] <= 0)):?>
                    ...
                    <?php if(isset($lecture['answers'][$question_category])) : if(($lecture['answers'][$question_category]['ugar_answer']=="")):?>
...
<section>
  ...
  <?php foreach($lecture['question_difficulty_type'] as $key=>$difficulty_question):?>
        ...
        <?php foreach($difficulty_question as $question_each): ?>
           ...
           <?php if(isset($lecture['answers'][$question_each])) : if($lecture['answers'][$question_each]['ugar_mark'] > 0):?>

                    <?php $right_answer_difficulty++; endif; endif; ?>

                    <?php if(isset($lecture['answers'][$question_each])) : if(($lecture['answers'][$question_each]['ugar_answer']!="") && ($lecture['answers'][$question_each]['ugar_mark'] <= 0)):?>
                    ...
                    <?php if(isset($lecture['answers'][$question_each])) : if(($lecture['answers'][$question_each]['ugar_answer']=="")):?>
                  ...
                  <div class="donuts-wrapper">
                      <div id="doughnutChart_<?php echo $key;?>" class="chart">
                          <div class="doughnutSummary">
                              <label><?php echo ($question_each!='')?$question_difficulty[$lecture['questions'][$question_each]['q_difficulty']]:$question_difficulty[$key];?></label>
                            </div><!--doughnutSummary-->
                        </div><!--chart-->
        ...
        <?php $character = array(); if(!empty($lecture['questions'])):?>
          ...
          <?php foreach ($lecture['questions'] as $key => $question):?>
            <?php $alphabet_count = 65; ?>
        	   <div class="single-choice-wraper <?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] <= 0){ echo 'wrong'; }?><?php if(!isset($lecture['answers'][$key]) ){ echo 'unattended'; }?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']=='' ){ echo 'unattended'; }?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] > 0){ echo 'right'; }?>" id="<?php echo $key.'_';?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] <= 0){ echo 'wrong'; }?><?php if(!isset($lecture['answers'][$key]) ){ echo 'unattended'; }?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']=='' ){ echo 'unattended'; }?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] > 0){ echo 'right'; }?>">
            	<div class="single-choice-header">
              	<span class="no-in-round <?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] <= 0){ echo 'no-in-round-red'; }?><?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']=='' ){ echo 'round-blue'; }?><?php if(!isset($lecture['answers'][$key]) ){ echo 'round-blue'; }?>"><?php echo $sl_no; ?></span><!--no-in-round-->
                ...
                <div class="choice-footer-wrap clearfix">
                    ...
                    <?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']=='' ) { ?>
                     ...
                     <?php if(isset($lecture['answers'][$key]) && $lecture['answers'][$key]['ugar_answer']!='' && $lecture['answers'][$key]['ugar_mark'] <= 0) { ?>
                              ...
                              <span class="your-answer-wrap-left-inside-text">Your answer</span>
                                ...
                                <?php 
                                  if(isset($lecture['question_type_wise']['1'])) :
                                    ...
                                    <?php if($options['id']==$lecture['answers'][$key]['ugar_answer']): ?>
                                ...
                                <?php 
                                  if(isset($lecture['question_type_wise']['2'])) :
                                    ...
                                    <?php if (strpos($lecture['answers'][$key]['ugar_mark'], ',') !== false) { ?>
                                    <?php $ans_array = explode(',',$lecture['answers'][$key]['ugar_answer']); ?>
                            ...
                            <span class="your-answer-wrap-right your-answer-wrap-right-modified">
                              <span class="small-device-border small-device-border-modified">
                                  <span class="time-taken margin-left-remove">Time Taken<strong>&nbsp;&nbsp;<?php echo $lecture['answers'][$key]['ugar_duration'];?>s</strong></span>
                                <span class="marks marks-right">Marks <span class="green right-text-red"><?php echo $lecture['answers'][$key]['ugar_mark'];?></span></span>
                          ...
                          <span class="your-answer-wrap-left">
                            ...
                            <span class="your-answer-wrap-right">
                              <span class="small-device-border">
								                <span class="time-taken">Time Taken<strong>&nbsp;&nbsp;<?php echo $lecture['answers'][$key]['ugar_duration'];?>s</strong></span>
                                <span class="marks">Marks <span class="green"><?php echo $lecture['answers'][$key]['ugar_mark'];?></span></span>
                                </span><!--small-device-border-->
  ...
  for (var key in chartArray){
      ...
      if (chartArray.hasOwnProperty(key)) {
        ...
        $("#doughnutChart_"+key).drawDoughnutChart([
          { 
            title: right_percentage+'%',
            value : right_answer,  
            color: "#00C853"
          },
          { 
            title: wrong_percentage+'%',
            value:  wrong_answer,   
            color: "#FF5252" 
          },
          { 
            title: unatt_percentage+'%',
            value:  unatt_answer,   
            color: "#3B4EA9" 
          }
        ]);
