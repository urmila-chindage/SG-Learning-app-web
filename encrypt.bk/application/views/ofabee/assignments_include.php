<div id="dashboard-my-assignments" class="tab-pane">
    <div class="row dash-row">    
        <div class="col-sm-12">
            ...
            <?php endif;  ?>
            <?php function print_assignments($assigs){ $theme = config_item('theme'); ?>
                <?php foreach($assigs as $assig): ?>
                    <?php if($assig['scored_mark'] == ''): ?>
                        ...
                        <li class="list-group-item single-assignment">
                            ...
                            <span class="assignment-slnmbr">1</span>
                    ...
                    <?php else: ?>
                        ...
                        <li class="list-group-item single-assignment">
                            ...
                            <span class="assignment-mark"><?php echo $assig['scored_mark']; echo ($assig['scored_mark']==0)?' Mark':' Marks'; ?></span>
                            <span class="report-action assignment-action"><a target="_blank" href="<?php echo site_url('materials/course/'.$assig['cl_course_id'].'/0/0#'.$assig['id']) ?>" class="report-link">View Details</a></span>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php } ?>
            <?php function print_lastDate($last_date){ ?>
