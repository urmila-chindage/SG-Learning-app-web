    ...
    <div class="container container-altr no-padding-xs">
        <div class="container-reduce-width">
            ...
            <div id="dashboard-my-courses" class="tab-pane active">
                <?php $course_url = ''; ?>
                <?php if(isset($subscription)&&count($subscription)>0){ ?>
                    <div class="row course-cards-row">
                    <ul class="ex-course-container my-bundles-list">
                    <?php foreach ($subscription as $course){
                    ...
                    <div class="row">    
                        <div class="col-sm-12 dashboard-no-course">
                            <div class="no-course-container">
                                ...
                                <span class="noquestion-btn-wrap "><a href="<?php echo site_url('course/listing') ?>" class="orange-flat-btn noquestion-btn browse-course-btn">Browse Bundles</a></span>
                                </div><!--text-center-->
                            </div>                 
                        </div>              
                    </div>
