        ...
        <div class="container">
            <div class="container-reduce-width clearfix">
                ...
                <span class="compare-btn-container" style="margin-top: 0">
                    <a href="<?php echo site_url('report/challenge_zone/'.$challenge_zone_report['challenge_zone_id']) ?>" id="" class="btn grey-flat-btn grey-flat-btn-to-orange">Back to Results</a>
                </span>
            </div>
        </div><!--container-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php foreach($category['percentage'] as $attempt_id => $percentage): ?>
                                    <td class="table-childs-compare compare_block_<?php echo $attempt_id ?>"><span class="table-child-span"><?php echo $percentage*100 ?>%</span></td>
                                <?php endforeach; ?>
                                <?php endif; ?>
                            </tr>                      
                            <?php endforeach; ?>
