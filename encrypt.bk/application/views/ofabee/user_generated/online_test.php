...
<html lang="en">
    <head>
        ...
        <link href="<?php echo assets_url('themes/' . config_item('theme') . '/assesment') ?>css/submit-test.css" rel="stylesheet">        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <script>
            ...
            var __exam_id       = '<?php echo $exam_id ?>';
        </script>
        <script src="<?php echo assets_url('themes/' . config_item('theme') . '/assesment') ?>js/user_generated.js"></script> 
