...
class Login extends CI_Controller {
    ...
    function login()
    {
        ...
        $data['redirect']           = ($this->session->flashdata('redirect'))? $this->session->flashdata('redirect'): "" ;
                ...
                switch($login['us_status'])
                {
                    case 1:
                        if ($redirect == '')
                        {
                            ...
                            $user_data['register_number']       = $login['us_register_number'];
                            ...
                            if($login['us_role_id'] == 1){
                                
                                $redirect = redirect(site_url($this->config->item('admin_folder').'/dashboard'));
                                exit;
                            }
                            else 
                            {
    ...
    public function password_set()
    {
        ...
        if(!empty($verify)){
            ...
            $user_data['register_number']       = $user_details['us_register_number'];
            $message_template                   = array();
