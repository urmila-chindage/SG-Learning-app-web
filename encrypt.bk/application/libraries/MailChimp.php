...
class MailChimp
{
    ...
    */
    ...
    {   
        ...
        $this->ci =& get_instance();
        $mailchimp_api    = $this->CI->settings->setting('has_mailchimp');
        if($mailchimp_api['as_superadmin_value'] && $mailchimp_api['as_siteadmin_value'])
        {
            $mailchimp_api_obj = $mailchimp_api['as_setting_value']['setting_value']; 
            $this->api_key = $mailchimp_api_obj->api_key;
