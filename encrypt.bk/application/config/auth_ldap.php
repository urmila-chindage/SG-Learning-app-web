...
$config['hosts'] = array('ldap.ofabee.com');
$config['ports'] = array(389);
$config['basedn'] = 'dc=ldap.ofabee,dc=com';
$config['login_attribute'] = 'ofabee';
$config['proxy_user'] = 'ldapuser1';
$config['proxy_pass'] = 'e2NyeXB0fXg=';
