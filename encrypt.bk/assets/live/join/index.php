<?php
  ...
  $started = true;
	...
	if(isset($_POST['name'])){
		 ...
		 $query = "INSERT INTO `college_name_latest` (`name`, `device`) VALUES ('$name','$device')";
		 mysql_query($query);
    }
	if($device == "apple")
	{
?>
<video src="http://54.169.181.40/ktulive/minister/playlist.m3u8" controls width="640" height="480"></video>
<?php
...
<?php } else{?>
	<div class="col-xs-12" style="text-align:center">
          ...
          <p class="title">The Honourable Pro-Chancellor and Minister of Education, Prof. C. Ravindranath would like to address the parents of discontinued first year students of A. P. J. Abdul Kalam Technological University.</p>
          <p class="date">Date: 10.08.2016 (Wednesday)</p>
...
playerInstance2.setup({
  ...
  playlist: [{
           sources: [{ 
            file: "rtmp://54.169.181.40/ktulive/minister"
        }]
    }],
  bufferlength:20,
  primary: "flash",
