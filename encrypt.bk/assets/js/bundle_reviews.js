...
function loadReviewssAdmin() {
    ...
    var flag = __offset;
    $.ajax({
        url: admin_url + 'bundle/load_reviews',
        type: "POST",
        data: {
            "is_ajax": '1', 
            'limit': __limit,
...
function deleteReviewConfirmed(params =''){
    ...
    //var courseId        = params.data.bundle_id;
    var userId          = params.data.userId;
    $.ajax({
        url: admin_url + 'bundle/delete_review',
        type: "POST",
        data: {
            "review_id": review_id,
            "bundle_id": __bundle_id,
...
//console.log('changeReviewStatusConfirmed', params);
    ...
    $.ajax({
        url: admin_url + 'bundle/change_reviews_status',
        type: "POST",
        data: {
            "review_id": review_id,
            "status": status,
...
$.ajax({
    url: admin_url + 'bundle/admin_review_reply',
    type: "POST",
    data: {
        "review_id": rvId,
...
function exportReviews(){
    //console.log('__bundle_id', __bundle_id);
    var param           = {
                            "bundle_id":    __bundle_id
                        };
    param               = JSON.stringify(param);
    var pathname        = '/admin/bundle/export_reviews';
