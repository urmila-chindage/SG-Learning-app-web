...
//require_once $_SERVER['DOCUMENT_ROOT'].'/ckfinder.php';
...
$domain_host = $protocol.($_SERVER['HTTP_HOST'] ? $_SERVER['HTTP_HOST'] : ($_SERVER['SERVER_NAME'] ? $_SERVER['SERVER_NAME'] : ($_SERVER['REMOTE_ADDR'] ? $_SERVER['REMOTE_ADDR'] : '')));
$baseUrl = $domain_host.'/uploads/'.$domain_name.'/ckfinder/';//userfiles
...
ATTENTION: The trailing slash is required.
*/
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/uploads/'.$domain_name.'/ckfinder/';//resolveUrl($baseUrl);
