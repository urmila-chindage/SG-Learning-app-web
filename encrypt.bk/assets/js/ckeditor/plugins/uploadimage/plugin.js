		...
		init: function( editor ) {
			...
			if ( !CKEDITOR.plugins.clipboard.isFileApiSupported ) {
				return;
                        ...
                        editor.config.uploadUrl = origin+'/assets/js/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files&responseType=json',

                        // Configure your file manager integration. This example uses CKFinder 3 for PHP.
                        editor.config.filebrowserBrowseUrl = origin+'/assets/js/ckeditor/plugins/ckfinder/ckfinder.html',
                        editor.config.filebrowserImageBrowseUrl = origin+'/assets/js/ckeditor/plugins/ckfinder/ckfinder.html?type=Images',
                        editor.config.filebrowserUploadUrl = origin+'/assets/js/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
                        editor.config.filebrowserImageUploadUrl = origin+'/assets/js/ckeditor/plugins/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';
