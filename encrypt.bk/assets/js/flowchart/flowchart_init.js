function init() {
      ...
      $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
        {
          ...
          model: new go.GraphLinksModel([  // specify the contents of the Palette
            ...
            { text: "Procedure", figure: "Procedure", fill: "lightskyblue" },
            { text: "Data", figure: "Parallelogram2", fill: "lightskyblue" },
 ...
 //   svg.style.border = "1px solid black";
  ...
  function generateImageHtmlCode()
  {
  ...
  {
      return typeof elementObject.name != 'undefined'?elementObject.name:'';
  }
