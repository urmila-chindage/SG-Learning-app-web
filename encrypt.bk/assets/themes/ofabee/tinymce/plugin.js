    ...
    AutoComplete.prototype = {
        ...
        show: function () {
            ...
            this.$dropdown = $(this.renderDropdown())
                                .css({ 'top': offset.top, 'left': offset.left,'visibility' : 'visible' });
        ...
        render: function (item) {
            return '<li>' + 
                        '<a href="javascript:;"><img class="" src="' + item['img'] + '" /><span>' + item[this.options.queryBy] + '</span></a>' +
                    '</li>';
        },
        ...
        insert: function (item) {
            return '<span class="name-orange" data-internalid="'+ item['email'] +'">@' + item[this.options.insertFrom] + '</span>&nbsp;';
        },
